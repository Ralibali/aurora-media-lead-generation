...
const STATIC_PAGES = [
  ...
  },
  {
    ...
    body: 'Aurora Media är en AI-konsult och AI-byrå i Sverige med två spår: konsultuppdrag inom AI-rådgivning, strategi, utbildning och utveckling i era team (895 kr/timme eller från 12 000 kr/månad) – samt fastprisprojekt där vi bygger SaaS, interna appar och AI-automationer från 14 900 kr. Kod ni äger.',
  },
  {
    route: '/tjanster',
  ...
  { route: '/priser', title: 'Priser för SaaS, prototyp, MVP och konsult', description: 'Fast pris från 14 900 kr för prototyp, 34 900 kr för MVP och 89 000 kr för skalbar SaaS. Konsultuppdrag 895 kr/timme eller från 12 000 kr/månad.', body: 'Aurora Media erbjuder fast pris för prototyper, MVP:er och skalbara SaaS-projekt – samt konsultuppdrag inom AI-rådgivning och utveckling för 895 kr/timme eller från 12 000 kr/månad. Du vet kostnaden innan arbetet börjar.' },
