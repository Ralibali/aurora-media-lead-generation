...
export const AURORA_PRODUCTS: AuroraProduct[] = [
  ...
  { name: "Aurora Ops", tagline: "Managed automation, analys, drift och kundkommunikation.", description: "Paketerar automationer, Pulse-analys, notifieringar, inbox och löpande drift till en tjänst som småföretag kan köpa utan att själva administrera verktygen.", group: "platform", status: "pilot", tags: ["Automation", "Analytics", "Managed drift"], href: "/aurora-ops" },
