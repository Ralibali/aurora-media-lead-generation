...
const SnabbanalysForm = ({
  ...
  const handleSubmit = async (ev: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitError(
        technical || !raw
          ? "Analysen kunde inte nås just nu – försök igen om en liten stund. Fungerar det fortfarande inte? Mejla info@auroramedia.se så gör vi analysen manuellt åt dig."
          : raw
      );
      setSubmitting(false);
