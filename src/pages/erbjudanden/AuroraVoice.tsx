...
import VoicePilotConfigurator from "@/components/verkstad/VoicePilotConfigurator";
  ...
  <>
    <OfferPage
      ...
      honesty={[
        ...
        "Pilotkonfiguratorn på sidan skapar bara ett underlag. Den aktiverar inte telefoni, AI eller en bokningsintegration automatiskt.",
