...
const GoogleAds = () => (
  <ServicePageTemplate
    ...
    tiers={[
      ...
      { name: "Setup + 3 mån", price: "9 900 kr", time: "Setup + 3 månaders optimering", desc: "Det vanligaste valet. Jag optimerar varje vecka i tre månader.", features: ["Allt i Setup", "Veckovis optimering", "A/B-test annonser", "Månatlig rapport"], featured: true },
    ...
    whyAffordable="Setup tar samma tid oavsett byrå – men de flesta byråer tar 12–25 000 kr för det och låser dig i sex månader. Jag tar fast pris och kräver inga bindningar. Vill du fortsätta är det för att det fungerar, inte för att du måste."
    faqs={[
