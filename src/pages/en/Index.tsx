...
const EnIndex = () => {
  ...
  useEffect(() => {
    setSEOMeta({
      title: "Ship SaaS in Weeks – Aurora Media, AI Builder Sweden",
      description:
        "Sweden-based AI builder shipping production SaaS in 2–4 weeks. 7 products live. Fixed price from $1,400. Book a free intro call.",
      canonical: "/en",
